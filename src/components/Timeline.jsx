...
const schedule = [
    ...
    { time: "08:00 PM", title: "Dinner", desc: "Refuel and recharge." },
];
        ...
        <section className="py-20 bg-slate-950 text-white relative">
            <div className="container mx-auto px-4 max-w-2xl relative">
                ...
                <div className="relative pl-8 border-l border-slate-800 space-y-12">
                    <div className="absolute left-[-1px] top-0 bottom-0 w-[2px] bg-gradient-to-b from-cyan-400 to-purple-500 shadow-[0_0_10px_rgba(34,211,238,0.5)]"></div>
